...
class VocabDataModel {
  ...
  VocabDataModel.fromJson(Map<String, dynamic> parsedJSON)
      : synonymList = _parseSynonymList(parsedJSON['synonymList']),
...
List<VocabDataModel> myList = [
  VocabDataModel(
    synonymList: ['in addition (to that)', 
  ...
  VocabDataModel(
    synonymList: ['..., such as', 'for instance', 'for example', 'e.g.'],
    topic: 'EXAMPLE',
  ...
  VocabDataModel(
    synonymList: ['however', 'whereas', 'but', 'otherwise', 'Unlike the other, ...', 
  ...
  VocabDataModel(
    synonymList: ['Although', 'Even though', 'Though', 'Despite', 'In spite of', 
  ...
  VocabDataModel(
    synonymList: ['Remarkably,', 'In particular,', 'Strikingly / More strikingly', 'In these settings', 
  ...
  VocabDataModel(
    synonymList: ['Due to (the fact that),', 'on account of (the fact that),', 
  ...
  VocabDataModel(
    synonymList: ['Therefore', 'consequently', 'thereby', 
  ...
  VocabDataModel(
    synonymList: ['XYZ is different from that seen in ABC. In ABC, the total number of...',
  ...
  VocabDataModel(
    synonymList: ['In case of ..., the ... can be supplemented.', 'To substitute for...',
   ...
   VocabDataModel(
    synonymList: ['XYZ have been broadly investigated on...', 'Although intuitive and functionally demonstrated in ... models',
  ...
  VocabDataModel(
    synonymList: ['essential', 'needed', 'mandatory', 'compulsory', 
  ...
  VocabDataModel(
    synonymList: ['Altogether, state-of-the-art data currently point to...', 
   ...
   VocabDataModel(
    synonymList: ['As a specific prerequeisite to this grant, XYZ have been collected / prepared...', 
   ...
   VocabDataModel(
    synonymList: ['Thit is the first proof of principle, that...', 
